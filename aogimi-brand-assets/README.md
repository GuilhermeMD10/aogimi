...
## File index
  ...
  wordmark/
    aogimi-wordmark.svg           — text-based SVG (requires Source Serif 4 installed)
    aogimi-wordmark-paper.svg     — wordmark in paper colour, for ink backgrounds
    aogimi-wordmark-{520x120,1040x240,2080x480}.png

  lockup/
    aogimi-lockup.svg             — mark + wordmark, horizontal
    aogimi-lockup-with-dot.svg    — same, with indigo dot
    aogimi-lockup-{600x120,1200x240,2400x480}.png (+ -dot- variants)
