    ...
    <Screen padded>
      <View style={styles.header}>
        <Pressable onPress={() => router.back()} hitSlop={10} style={styles.backRow}>
          ...
          <Text style={[styles.backLabel, { color: c.fgMuted, fontFamily: fontFamily.ui }]}>Settings</Text>
        </Pressable>
        <Text style={[styles.title, { color: c.fg, fontFamily: fontFamily.ui }]}>Help</Text>
      </View>

      <ScrollView contentContainerStyle={styles.body}>
        <Section heading="What is Shirube?" fg={c.fg} fgMuted={c.fgMuted} pinned>
          <P fgMuted={c.fgMuted}>
            Shirube is a Japanese reading and vocabulary companion. Open an EPUB or PDF, look up any word in the
...
function Section({
   ...
   *  orientation section ("What is Shirube?") that should never hide. */
  pinned?: boolean;
}) {
...
const styles = StyleSheet.create({
  header: { marginBottom: spacing.md, paddingVertical: spacing.md },
  backRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 2,
