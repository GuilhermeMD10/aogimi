...
export type SkyCard = {
  ...
  mastery: number;
  /** How brightly the star burns, 0..1 — the host's retrievability. Separate
   *  from `mastery` on purpose: rank says what was achieved, this says how
   *  fresh it is *now*, and a card can be high-rank and dim. Omitted means
