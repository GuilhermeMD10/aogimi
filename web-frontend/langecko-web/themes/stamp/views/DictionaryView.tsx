...
import { JlptChip } from '@/components/views/DictionaryView/DictionaryView';
import type { DictionaryViewProps } from '@/components/views/DictionaryView/DictionaryView';
    ...
    <div className="@container flex min-h-full w-full flex-col">
      ...
      >
        <form
          ...
          style={{ maxWidth: 540, borderRadius: 0 }}
        >
