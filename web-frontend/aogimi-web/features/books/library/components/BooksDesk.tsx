...
function deriveSyncState(book: Book): SyncPillState {
    ...
    <div className="h-full overflow-auto" style={{ background: 'var(--lgc-bg)' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: '34px 40px 140px' }}>
        ...
        {filteredGrid.length > 0 ? (
          ...
          <p style={{ marginTop: 8, fontSize: 13, color: 'var(--lgc-fg-muted)' }}>No books match this filter.</p>
        )}
...
function LibraryHeader({
  ...
  return (
    <div
      style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 24, marginBottom: 22 }}
    >
      <div style={{ minWidth: 0 }}>
        <div className="lgc-section-label" style={{ marginBottom: 4 }}>
          Your library
        </div>
        <h1
        ...
        <div style={{ marginTop: 6, fontSize: 12.5, color: 'var(--lgc-fg-muted)' }}>{subtitleParts.join(' · ')}</div>
      </div>
...
function FilterChips({
  ...
  return (
    <div role="tablist" style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 22 }}>
      ...
      <span
        style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--lgc-fg-muted)', fontFamily: 'var(--lgc-font-mono)' }}
      >
  ...
  return (
    ...
    >
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <div style={{ marginTop: 4, fontSize: 13, color: 'var(--lgc-fg-muted)' }}>{book.author}</div>
...
function MenuItem({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLElement).style.background = 'var(--lgc-bg-sunken)';
      }}
      onMouseLeave={(e) => {
