...
export default function Sky() {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      {/* `SkyStats` is deliberately not rendered — the demo's readout of zoom, layer phase and the
          open session went with the stage's zoom readout. The component is still in this folder;
          re-mounting it needs `fitZoom` from `lib/camera` and `openConstellationOf(…, focus[0])`
          back, both of which came out with it rather than sit here unused. */}
