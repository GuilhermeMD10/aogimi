...
/**
 * The whole sky — every deck at once, as the /sky stage draws it. The production sibling of
...
export function SkyMap({
  ...
  const cam = useCamera(stage.bounds, {
    ...
    // rather than floating in the middle of it; the outer chooser keeps the constant caps (moot
    // while locked, but stated for the flight out)
