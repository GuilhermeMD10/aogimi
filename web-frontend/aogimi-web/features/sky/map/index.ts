 ...
 * nothing about decks, routes or the API: hand it a seed and card rows and it draws. The page that
 ...
 *
 * Wired today: **the /sky stage** (`features/sky/stage/views/SkyView`), which composes
