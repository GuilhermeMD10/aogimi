...
│
└── public/, langeco-DS/          Static assets + design canvas reference
```
...
| **IndexedDB** (`langeco-books`) | EPUB / PDF blobs + per-file metadata | Per-device — files don't leave the browser |
